        ...
        {suggestionStatus === "waiting" ? (
            ...
            {streamedResponse && (
              <div className="bg-[#374151] p-4 rounded-lg border border-[#E91E63] transition-colors">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#E91E63] rounded-full mt-2 flex-shrink-0 animate-pulse"></div>
          ...
          suggestions.map((suggestion, index) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-2 h-2 ${index === 0 ? "bg-[#E91E63]" : "bg-green-500"} rounded-full mt-2 flex-shrink-0`}
                ></div>
                <p className="text-md text-gray-300">{suggestion}</p>
              </div>
            </div>
