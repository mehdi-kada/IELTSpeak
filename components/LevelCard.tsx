              ...
              <div className="group relative bg-[#2F2F7F]/50 border border-white/10 p-8 rounded-xl overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-1.5 hover:border-[#E62136]">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                    <div className="flex flex-col gap-4 w-full">
                        <Link href="#" className="w-full text-center bg-[#E62136] hover:shadow-md hover:shadow-[#E62136]/30 hover:-translate-y-px transition-all duration-200 text-white font-bold py-3 px-4 rounded-lg">Exam Mode</Link>
                        <Link href="#" className="w-full text-center border-2 border-[#E62136] text-[#E62136] hover:bg-[#E62136]/10 transition-colors font-bold py-2.5 px-4 rounded-lg">Practice Mode</Link>
                    </div>
                </div>
              </div>
  );
