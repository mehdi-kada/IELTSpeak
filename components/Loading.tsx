...
function LoadingSpinner({ 
  ...
  return (
    <div className={containerClasses}>
      ...
      <div className={`sound-wave flex items-center justify-center ${sizeClasses[size]}`}>
        <div className={`${barWidth[size]} h-full bg-[#E62136] rounded-full`} style={{ animationDelay: '-0.5s' }}></div>
        <div className={`${barWidth[size]} h-full bg-[#E62136] rounded-full`} style={{ animationDelay: '-0.4s' }}></div>
        <div className={`${barWidth[size]} h-full bg-[#E62136] rounded-full`} style={{ animationDelay: '-0.3s' }}></div>
        <div className={`${barWidth[size]} h-full bg-[#E62136] rounded-full`} style={{ animationDelay: '-0.2s' }}></div>
        <div className={`${barWidth[size]} h-full bg-[#E62136] rounded-full`} style={{ animationDelay: '-0.1s' }}></div>
      </div>
