...
function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center bg-[#1F2937]">
      {" "}
      {/* Added background */}
      <h1 className="text-9xl font-black text-[#374151] relative">
        404
        <span
          className="absolute top-0 left-0 w-full h-full text-[#E91E63] opacity-70"
